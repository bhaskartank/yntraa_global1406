...
type ListTopupWithdrawalRequestsDetailProps = {
  requestData: any;
...
export default function ListTopupWithdrawalRequestsDetail({ requestData, handleApproveReq, handleRejectReq, requestDetailPage = false }: ListTopupWithdrawalRequestsDetailProps) {
