    ...
    <Modal
      ...
      <Slide in={isOpen} direction="down">
        <Stack
          ...
          {/* Modal Header */}
          {!hideHeader ? (
            <Stack direction="row" justifyContent="space-between" alignItems="center" px={3} py={1} sx={{ backgroundColor: "primary.light", color: "common.black" }}>
          ...
          <Box flex={1}>
            ...
            <Box overflow="scroll" sx={{ overflow: "auto", p: !(hideHeader && hideActions) ? "24px 24px 16px" : 0, ...bodyStyle }}>
              {children}
            </Box>
          </Box>
            ...
            <>
              <Stack direction="row" alignItems="center" px={3} py={1.5}>
                {actions ? (
                  ...
                  <Stack direction="row" justifyContent="center" alignItems="center" spacing={2} flex="1">
                    {onConfirm ? (
